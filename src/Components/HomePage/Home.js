        ...
        <section id="features" className="features">
          ...
          <div className="feature-card">
            <div className="feature">
              <img src={previewImage} className="email-image" alt={t("home.features.automated_email_campaigns.title")} />
          ...
          <div className="feature-card-middle">
            <div className="feature reversed">
              <img src={insightsImage} className="email-image-middle" alt={t("home.features.actionable_insights.title")} />
              <div className="feature-text">
          ...
          <div className="feature-card">
            <div className="feature">
              <img src={dataImage} className="email-image" alt={t("home.features.seamless_data_collection.title")} />
              <div className="feature-text">
